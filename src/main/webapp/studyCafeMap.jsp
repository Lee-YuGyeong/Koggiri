        ...
        <div class="option">
            <div>
                <form onsubmit="searchPlaces(); return false;">
                    키워드 : <input type="text" value="홍대 스터디 카페" id="keyword" size="15"> 
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=c5a3e3b52b23e552427182a08788c045&libraries=services"></script>
<script>
// 마커를 담을 배열입니다
var markers = [];
